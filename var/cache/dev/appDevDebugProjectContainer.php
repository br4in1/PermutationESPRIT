...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' => 'get133fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService',
            '2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' => 'get233fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService',
        ...
        $this->privates = array(
            '1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' => true,
            '2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd']) ? $this->services['1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd'] : $this->get133fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd']) ? $this->services['2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd'] : $this->get233fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6b44c29dafe042e09f4365f5d571808cf2b56f35fd7f9d3ecdf2e9972a350da9');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = ${($_ = isset($this->services['session']) ? $this->services['session'] : $this->get('session')) && false ?: '_'};
        $g = ${($_ = isset($this->services['translator']) ? $this->services['translator'] : $this->get('translator')) && false ?: '_'};
        ...
        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/permutation');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/permutation_classes');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/covoiturage');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/colocations');
        ...
        $t = new \Symfony\Component\Security\Http\HttpUtils($e, $e, '{^https?://%s$}i');
        ...
        $u->addHandler(new \Symfony\Component\Security\Http\Logout\CsrfTokenClearingLogoutHandler(${($_ = isset($this->services['security.csrf.token_storage']) ? $this->services['security.csrf.token_storage'] : $this->getSecurity_Csrf_TokenStorageService()) && false ?: '_'}));
        $u->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $v = new \AppBundle\Handler\AuthenticationHandler($e, $f, $g);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($s, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['fos_user.user_provider.username']) ? $this->services['fos_user.user_provider.username'] : $this->getFosUser_UserProvider_UsernameService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $u, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $t, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($v, array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($v, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5b8ee751f25a78.65495396', $a, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $s, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $t, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(${($_ = isset($this->services['http_kernel']) ? $this->services['http_kernel'] : $this->get('http_kernel')) && false ?: '_'}, $t, '/login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'fos_user.user_provider.username', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    /**
     * Gets the private '1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get133fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService()
    {
        return $this->services['1_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get233fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cdService()
    {
        return $this->services['2_33fd35b897299e752ffd63cd5e878f628bef7fb832bf21e73b2db09fbb26e4cd'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BYmTX39y5c', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sK8eIW3Fzo', 0, 'CSb1vg8FsUTWxNh5WGv+17', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9fj3VMQC+z', 0, 'CSb1vg8FsUTWxNh5WGv+17', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6KSBgG1Bk7', 0, 'CSb1vg8FsUTWxNh5WGv+17', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b8ee751f25a78.65495396');
    }
